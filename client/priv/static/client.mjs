...
var Element = class extends CustomType {
  constructor(key2, namespace2, tag2, attrs, children, self_closing, void$) {
    super();
    this.key = key2;
...
function decode_websocket_response(text3) {
  ...
  let response_with_type = decode4(text3, type_decoder);
  let _pipe = (() => {
...
function header(model) {
  if (model instanceof NotInRoom && model.route instanceof Home) {
    ...
    return div(
      ...
      toList([
        nav(
          toList([class$("flex items-center bg-emerald-100 text-green-900")]),
          toList([
            link2(
              "/",
              toList([
